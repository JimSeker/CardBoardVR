...
//                                         X  Y  Z
    ...
    public void onFinishFrame(Viewport viewport) {
        //we are not doing anything after the drawing, but before the display, so nothing here.
    }
    ...
    public void resetcamera() {
        moving = false;  //make sure not moving.
        // Build the camera matrix back to default.
